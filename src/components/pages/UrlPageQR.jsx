...
const UrlPageQR = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#cce3ff] to-[#f0f8ff] w-full min-h-[100vh] flex justify-center items-center">
      <div className="bg-white w-96 h-full flex flex-col justify-center items-start gap-4">
        ...
        <div className="px-2 flex flex-col gap-2">
          ...
          <Link
            ...
            type="button"
            to={`/${orgId}/${eventId}/register-user`}
          >
            Register
          </Link>
        </div>
